      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          >
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-gray-400 group-hover:text-neon-cyan transition-colors text-sm sm:text-base break-all">
                        {info.content}
                      </p>
                    </div>
                  </motion.a>
            ...
            {/* Quick Info */}
            <div className="glass rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
              <h4 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-white">What I Offer</h4>
          ...
          >
            <div className="glass rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
              <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Send Message</h3>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-neon-cyan focus:bg-white/15 transition-all duration-300 text-sm sm:text-base"
                ...
                >
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-neon-cyan focus:bg-white/15 transition-all duration-300 resize-none text-sm sm:text-base"
