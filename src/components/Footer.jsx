...
const Footer = () => {
  ...
  return (
    <footer className="relative py-12 sm:py-16 lg:py-20 px-3 sm:px-4 lg:px-8 border-t border-gray-200 dark:border-white/10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-2.5 sm:p-3 glass rounded-full text-gray-600 dark:text-gray-400 hover:text-neon-cyan transition-colors duration-300"
          ...
          >
            <h4 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-white">Quick Links</h4>
            <nav className="space-y-2 sm:space-y-3">
              {quickLinks.map((link) => (
                <motion.a
                  ...
                  href={link.href}
                  whileHover={{ x: 5 }}
                  className="block text-gray-600 dark:text-gray-400 hover:text-neon-cyan transition-colors duration-300 text-sm sm:text-base"
                >
                  {link.name}
                </motion.a>
              ))}
          ...
          <motion.div
            ...
            className="space-y-4 sm:space-y-6"
          >
            <h4 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-white">Get In Touch</h4>
            <div className="space-y-3">
              <div className="text-gray-600 dark:text-gray-400">
                <p className="font-medium text-gray-800 dark:text-white text-sm sm:text-base">Email</p>
              ...
              <div className="text-gray-600 dark:text-gray-400">
                <p className="font-medium text-gray-800 dark:text-white text-sm sm:text-base">Phone</p>
                <a href="tel:+918700458678" className="hover:text-neon-cyan transition-colors text-sm sm:text-base">
                  +91 8700458678
                </a>
              </div>
              <div className="text-gray-600 dark:text-gray-400">
                <p className="font-medium text-gray-800 dark:text-white text-sm sm:text-base">Location</p>
                <a 
        ...
        >
          <div className="text-center">
            <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800 dark:text-white mb-2">Stay Updated</h4>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 max-w-md mx-auto">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-100 dark:bg-white/10 border border-gray-300 dark:border-white/20 rounded-xl text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-neon-cyan transition-all duration-300 text-sm sm:text-base"
              />
              <motion.button
        ...
        {/* Bottom Section */}
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 sm:pt-8 border-t border-gray-200 dark:border-white/10 space-y-4 sm:space-y-0">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 text-sm sm:text-base"
          >
            <span>Made with</span>
            <motion.div
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="p-2 glass rounded-full text-gray-600 dark:text-gray-400 hover:text-neon-cyan transition-colors duration-300"
